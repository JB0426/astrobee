...
desired_position = Vector3(x=11.0, y=-6.0, z=4.8)
...
rospy.init_node("queen_auto_nav")
rate = rospy.Rate(80)
pub = rospy.Publisher("/queen/gnc/ctl/command", FamCommand, queue_size=1)
...
rospy.Subscriber("/queen/gnc/ekf", EkfState, callback)
...
def calculate_commands():
    ...
    if distance_to_target > distance_threshold:
        ctl_msg.mode = 2
        # Proportional control for linear motion
        cmd_msg.wrench.force.x = kp_linear * error_linear.x *0.25
        cmd_msg.wrench.force.y = kp_linear * error_linear.y *0.25
        cmd_msg.wrench.force.z = kp_linear * error_linear.z *0.25
        
        # Proportional control for angular motion
        cmd_msg.wrench.torque.x = kp_angular * error_orientation.x *0.4
        cmd_msg.wrench.torque.y = kp_angular * error_orientation.y *0.4
        cmd_msg.wrench.torque.z = kp_angular * error_orientation.z *0.4
